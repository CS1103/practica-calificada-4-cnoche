...
/* *******************
    Color filtering
********************** */
void iterate_red(std::vector<unsigned char>& image, 
    unsigned int start, unsigned int end, unsigned int w)
{
...
void iterate_blue(std::vector<unsigned char>& image, 
    unsigned int start, unsigned int end, unsigned int w)
{
    for (unsigned int i = start; i < end; i++) 
    {
...
void iterate_green(std::vector<unsigned char>& image, 
    unsigned int start, unsigned int end, unsigned int w)
{
    for (unsigned int i = start; i < end; i++)
    {
